  ...
  void loop() {
    ...
    if(distancia <250){
      ...
      json1.set("/valorX", String(AcX / A_R));
      json1.set("/valorY", String(AcY / A_R));
      json1.set("/valorZ", String(AcZ / A_R));
      json1.set("/description", "Computadora Hp");
      json1.set("/id", punteros);
      json1.set("/task", "Sigue en el rango");
      json1.set("/distanciaCM", distancia);
      json1.set("/giroX",String(Angle[0]) );
      json1.set("/giroY",String(Angle[1]) );
      json1.set("/giroZ",String(Angle[2]));
      ...
      if (Firebase.pushJSON(firebaseData, path, json1))
      {
      ...
      json1.set("/description", "Computadora Hp");
      json1.set("/id", punteros);
      json1.set("/task", "Salio del rango admitido");
      json1.set("/distanciaCM", distancia);
      json1.set("/giroX",String(Angle[0]) );
      json1.set("/giroY",String(Angle[1]) );
      json1.set("/giroZ",String(Angle[2]));
